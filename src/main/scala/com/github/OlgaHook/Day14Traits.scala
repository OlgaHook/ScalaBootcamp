...
//then at some point I can use com.github.OlgaHook.RealDog extends com.github.OlgaHook.PlatonicDog
...
//at some point I need to create a com.github.OlgaHook.RealDog that inherits from abstract class
