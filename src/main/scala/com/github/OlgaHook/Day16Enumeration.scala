...
import com.github.OlgaHook.Fingers.Finger
...
//notice object so singleton meaning we only have one com.github.OlgaHook.Color object
...
object Fingers extends Enumeration {
  type Finger = Value //so all com.github.OlgaHook.Fingers have same type of Value
...
object Day16Enumeration extends App {
  ...
  println("How about the com.github.OlgaHook.Fingers?")
